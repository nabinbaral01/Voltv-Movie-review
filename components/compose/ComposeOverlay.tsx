...
export default function ComposeOverlay({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[900] flex items-start justify-center">
      ...
      <div className="relative w-full max-w-[600px] mt-[5vh] sm:mt-[10vh] mx-4 bg-[#0F0F18] border border-[#1E1E2E] rounded-2xl shadow-2xl shadow-black/50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
            ...
            <div className="flex-1 min-w-0">
              <div className="mb-2">
                <select
                  ...
                  className="appearance-none pl-3 pr-6 py-1 rounded-full text-xs font-semibold bg-transparent text-[#E50914] border border-[#E50914]/30 hover:bg-[#E50914]/10 focus:outline-none cursor-pointer transition-colors"
                >
        ...
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-1">
            ...
            <ToolBtn icon={<AlertTriangle size={18} />} label="Spoiler" onClick={() => setSpoiler(!spoiler)} active={spoiler} />
            <ToolBtn icon={<EyeOff size={18} />} label="Anonymous" onClick={() => setAnonymous(!anonymous)} active={anonymous} />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={submit}
              disabled={!canPost}
              className="h-9 px-5 rounded-full text-sm font-bold text-white bg-[#E50914] hover:bg-[#C50812] disabled:opacity-40 disabled:hover:bg-[#E50914] transition-colors"
            >
